...
.directive('sig', ['$rootScope','renderGraphfactory', 'eventBridgeFactory','dataGraph', 'labelService', 'graphSelectionService', 'zoomService', 'tagService', 'graphHoverService', 'inputMgmtService', 'SelectionSetService', 'BROADCAST_MESSAGES',
function ($rootScope, renderGraphfactory, eventBridgeFactory, dataGraph, labelService, graphSelectionService, zoomService, tagService, graphHoverService, inputMgmtService, SelectionSetService, BROADCAST_MESSAGES) {
    'use strict';
