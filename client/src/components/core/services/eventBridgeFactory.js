angular.module('common')
    .service('eventBridgeFactory', ['$q','$timeout', 'renderGraphfactory', 'inputMgmtService', 'graphHoverService','graphSelectionService', 'nodeSelectionService',
        function ($q, $timeout, renderGraphfactory, inputMgmtService, graphHoverService, graphSelectionService, nodeSelectionService) {
    ...
    **************************************/
            ...
            function hoverOutHandler (name, event) {
                ...
                graphHoverService.hoverOutHandler(name, event, inputMgmtService.inputMapping().hoverStage, 0);
