angular.module('player')
    ...
    **************************************/
            ...
            loadPlayerData.promise
                .then(function(dataset){
                    ...
                    $scope.hasModal = true;
                    $scope.panelUI.openPanel($scope.player.settings.showModal ? 'modal' : 'filter');
    ...
    **************************************/
            ...
            function updateOnDsOrNwChange() {
                ...
                playerFactory.getPlayer(reqUrl)
                    .then(function(playerDoc){
                        ...
                        return $q.all([
                            dataService.fetchProjectDataSet(playerDoc.org.ref, playerDoc.project.ref),
                            networkService.fetchProjectNetworks(playerDoc.org.ref, playerDoc.project.ref)
                        ]);
